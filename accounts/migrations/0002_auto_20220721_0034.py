# Generated by Django 4.0.6 on 2022-07-21 00:34
...
def populate_roles(apps, schemaeditor):
    roles = {
        ...
        "columist": "A user that writes content for a column",
...
def populate_departments(apps, schemaeditor):
    departments = {
        "front_paper": "A department tasked with writing front page articles",
